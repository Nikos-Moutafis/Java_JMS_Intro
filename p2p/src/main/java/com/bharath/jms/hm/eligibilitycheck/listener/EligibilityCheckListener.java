package com.bharath.jms.hm.eligibilitycheck.listener;
...
public class EligibilityCheckListener implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		try (ActiveMQConnectionFactory cf = new ActiveMQConnectionFactory();
			...
			if (insuranceProvider.equals("Blue Cross Blue Shield")) {
				System.out.println("Patient's copay is: " + patient.getCopay());
				System.out.println("Amount to be paid is: " + patient.getAmountToBePayed());
